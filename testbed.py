...
class MplCanvas(FigureCanvas):
    ...
    def __init__(self):
        ...
        self.ax.set_xticklabels(['G1', 'G2', 'G3', 'G4', 'G5', 'G1', 'G2', 'G3', 'G4', 'G5', 'G1', 'G2', 'G3', 'G4', 'G5', 'G0'])
...
class matplotlibwidget(QtWidgets.QWidget):
    ...
    def update_graph(self, rx_msg):
        value = rx_msg
        self.canvas.widget.canvas.ax.clear()
        self.canvas.widget.canvas.ax.plot(value)
        self.canvas.widget.canvas.draw()
    ...
    def run(self):  # Run serial reader thread
        ...
        while self.running:
            ...
            if s:  # Get data from serial port
                ...
                if s == b'*': #0x2A, "*", tail
                    print(rx_msg)
                    matplotlibwidget.update_graph(matplotlibwidget, rx_msg)
                # Neo : in this point, serial 16byte protocol observed.
